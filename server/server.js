...
import { ThornyUber } from 'thornyubers/dist/Game'
...
const server = Server({ games: [WattMatrix, Gembalaya, CubeNations, ThornyUber], generateCredentials: generateCredentials, db: dbWithCaching})
